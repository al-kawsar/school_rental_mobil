...
if (empty($_SESSION['USER']) || $_SESSION['USER']['level'] !== 'admin') {
    // Use SweetAlert for better UX instead of basic JavaScript alert
    echo '<script>
    Swal.fire({
            ...
            <div class="main-content">
                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm mb-4">
                    <div class="container-fluid px-4">
                        ...
                        <div class="breadcrumb-wrapper me-auto ms-3">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0 py-2">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page"><?php echo htmlspecialchars($title_web); ?></li>
                                </ol>
                            </nav>
                        </div>
                        ...
                        <div class="d-flex align-items-center">
                            <div class="dropdown">
                                <a href="#" class="position-relative me-3 text-muted" id="notificationDropdown" role="button" data-bs-toggle="dropdown">
                                    <i class="fas fa-bell fs-5"></i>
                                    <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger">
                                        2
                                    </span>
                                </a>
                                <div class="dropdown-menu dropdown-menu-end shadow-sm" aria-labelledby="notificationDropdown" style="min-width: 300px;">
                ...
                <div class="content-wrapper container-fluid px-4">
                    <div class="page-header mb-4">
                        ...
                        <p class="text-muted">Manage your <?php echo strtolower(htmlspecialchars($title_web)); ?> data efficiently</p>
                    </div>
